...
func _ready():
    player_party.familiars.append(Familiar.new("SPHYNX", 20))
    player_party.familiars[0].nickname = "Beerus"
    player_party.familiars.append(Familiar.new("SLIME", 20))
    player_party.familiars[1].nickname = "Deputy"
    player_party.familiars.append(Familiar.new("MIMIC", 3))
